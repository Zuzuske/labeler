#!/bin/python
"""
My made changes are anotated with # changed anotation
"""
...
'''
parser.add_argument('--tracker', default='DASIAMRPN', type=str,
                ...
                with open(ann_path, 'w') as new_file:
                    for line in lines:
                        if line != yolo_line + '\n':
                            ...
                            new_yolo_line = yolo_format(class_index, (new_x_left, new_y_top),
